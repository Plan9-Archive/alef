...
enum
{
	...
	MARITH		= (MLINT|MLUINT|MINT|MUINT|MSINT|MSUINT|MCHAR|MFLOAT),
	MUNSIGNED	= (MCHAR|MLUINT|MUINT|MSUINT|MIND),
	MBOOL		= (MARITH|MIND),
	MSCALAR		= (MARITH|MIND),
	MINCDEC		= (MLINT|MLUINT|MINT|MUINT|MSINT|MSUINT|MCHAR|MIND),
	MCOMPLEX	= (MADT|MUNION|MAGGREGATE),
	MCONVIND	= (MINT|MUINT|MIND),
	MINTEGRAL	= (MLINT|MLUINT|MINT|MUINT|MSINT|MSUINT|MCHAR),
};
