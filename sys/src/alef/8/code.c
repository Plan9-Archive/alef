...
/* Load/store instructions by type
	TXXX  	TLINT	TLUINT	TINT	TUINT	TSINT	TSUINT	TCHAR
	TFLOAT	TIND	TCHAN	TARY	TAGG	TUNI	TFUNC	TVOID
*/
int ostore[] ={
	AGOK, AMOVL, AMOVL, AMOVL, AMOVL, AMOVW, AMOVW, AMOVB,
	AFMOVDP, AMOVL, AMOVL, AGOK, AGOK, AGOK, AGOK, AGOK
};

int oload[] = {
	AGOK, AMOVL, AMOVL, AMOVL, AMOVL, AMOVWLSX,AMOVWLZX,AMOVBLZX,
	AFMOVD, AMOVL, AMOVL, AGOK, AGOK, AGOK, AGOK, AGOK
};
